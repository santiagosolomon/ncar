...
export default function IncidentModal({
  ...
  const setIncidentDetails = (
    updater: (prev: IncidentDetails[]) => IncidentDetails[]
  ) => {
    setForm((prev) => ({
      ...prev,
  ...
  const setIncidentIssues = (
    updater: (prev: IncidentIssues[]) => IncidentIssues[]
  ) => {
    setForm((prev) => ({
      ...prev,
  ...
  const setIncidentEvaluation = (
    updater: (prev: IncidentEvaluation[]) => IncidentEvaluation[]
  ) => {
    setForm((prev) => ({
      ...prev,
  ...
  const setIncidentActions = (
    updater: (prev: IncidentActions) => IncidentActions
  ) => {
    setForm((prev) => ({
      ...prev,
      incidentActions: [
        updater(
          prev.incidentActions[0] || {
    ...
    <form onSubmit={handleSubmit} className="space-y-4 ">
      ...
      <div className="grid grid-cols-2 gap-4 ">
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-2">
            <Input
              ...
              onChange={(e) =>
                handleChange("reportingDepartment", e.target.value)
              }
        ...
        <div className="space-y-2 w-full">
          ...
          >
            ...
            <SelectContent>
              <SelectItem value="Internal Incident">
                Internal Incident
              </SelectItem>
              <SelectItem value="External Incident">
                External Incident
              </SelectItem>
      ...
      <div className="space-y-2 w-full">
        ...
        <Select
          ...
          onValueChange={(value) => {
            handleChange(
              "concernType",
              value as "supplier" | "customer" | "department"
            );
      ...
      <div className="p-4 border rounded-lg w-full bg-white dark:bg-sky-900">
        ...
        <RadioGroup
          ...
          onValueChange={(value) =>
            handleChange("moduleOfPurchase", value as "Imported" | "Local")
          }
